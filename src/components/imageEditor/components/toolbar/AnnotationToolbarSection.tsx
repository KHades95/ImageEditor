...
export const AnnotationToolbarSection = ({ annotation, imageUrl, onChangeAnnotation, onDeleteAnnotation, onAIAnnotation }: AnnotationToolbarSectionType) => {
  return (
    <div className="flex flex-col justify-center items-center gap-2">
      <div className="join">
        ...
        <button className={`btn btn-ghost btn-sm`} title='AI' disabled={!imageUrl} onClick={onAIAnnotation}>
          <Brain size={20} />
        </button>
