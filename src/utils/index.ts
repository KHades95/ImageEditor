...
export const drawAIAnnotation = (canvas: fabric.Canvas, color: string, bgColor: RgbaColor, strokeWidth: number, handleObjectAdd: (obj: AnnotationsTableDataType) => void) => {
  initEvent(canvas);
